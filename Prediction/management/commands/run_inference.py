...
from Prediction.models import lateBligtPrediction
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        def perform_inference():
            ...
            # Find document created on the current date
            latest_data = lateBligtPrediction.find_one({
            ...
            if  latest_data:
                ...
                try:
                    for index, row in df_locations.iterrows():
                        ...
                        lateBligtPrediction.insert_one(document)
